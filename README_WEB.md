...
السيرفر الحالي: `https://broost-production-1dcb.up.railway.app`.
إصدار الكاشير الجديد يرحّل عنوان Railway القديم المحفوظ تلقائيًا، ويحافظ على قاعدة بيانات المطعم ومفتاح المزامنة، ويعيد مطابقة سجل الطلبات مع السيرفر الجديد.
عند التحديث احتفظ بملف `broost_pos.db` الموجود على جهاز الكاشير؛ لا تستبدله بقاعدة جهاز التطوير.
بعد نشر الموقع، اختيار «كل الأيام» يعرض السجل كاملًا، وزر «كل التفاصيل» متاح للطلبات الجارية والمكتملة والملغاة.
